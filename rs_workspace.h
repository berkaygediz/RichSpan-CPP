...
private:
    ...
    QAction *undoaction, *redoaction, *theme_action, *powersaveraction, *findaction;
    QAction *replaceaction, *helpAction, *aboutAction;
    QAction *alignrightevent, *aligncenterevent, *alignleftevent, *alignjustifiedevent;
    QAction *bold, *italic, *underline, *bulletevent, *numberedevent, *color;
    QAction *backgroundcolor, *fontfamily, *addimage;
    QToolBar *file_toolbar, *ui_toolbar, *edit_toolbar, *font_toolbar, *list_toolbar;
...
private slots:
    ...
    void themePalette();
    void translateToolbarLabel(QToolBar *toolbar, const QString &labelKey, const QString &lang);
    ...
    QAction *createAction(const QString &text, const QString &statusTip,
                          std::function<void()> function, const QKeySequence &shortcut);
